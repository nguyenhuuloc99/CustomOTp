...
public class CustomOtp extends FrameLayout {
    ...
    public CustomOtp(@NonNull Context context) {
        super(context);
        this.context = context;
        init(null);
    }

    public CustomOtp(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
    }

    public CustomOtp(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
